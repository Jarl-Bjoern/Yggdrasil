...
"""
  ...
  optional.add_argument('-raCf','--read-automation-config-file', type=bool, nargs='?', const=True, default=False, help=Colors.GREEN+'UNDER CONSTRUCTION.\n\n'+Colors.RESET+f"Default: {dirname(realpath(__file__)).replace('Resources/Python/Standard_Operations', 'Config/Automation/Install.cfg')}\n\n"+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
  optional.add_argument('-rCC','--read-custom-config', type=bool, default="EMPTY", help=Colors.GREEN+'UNDER CONSTRUCTION.\n\n'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
