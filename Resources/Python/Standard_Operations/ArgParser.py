...
"""
  ...
  if (osname == 'nt'):
      ...
      optional.add_argument('-v','--verbose', type=bool, nargs='?', const=True, help=Colors.GREEN+'This parameter shows all interaction messages during the apt package manager installation process.\n\n'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
