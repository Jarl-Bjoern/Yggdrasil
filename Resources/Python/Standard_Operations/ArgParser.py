...
"""
  ...
  if (osname == 'nt'):
      ...
      optional.add_argument('-aL','--accept-licenses', type=bool, nargs='?', const=True, help=Colors.GREEN+'This parameter is required to accept licenses the popups from firefox during the installation of extensions.'+Colors.RESET+'\n\nExtensions:\n  - Firefox\n\nLicenses:\n  - Veracrypt\n\n'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
      ...
      optional.add_argument('-sD','--skip-days', type=int, default=90, help=Colors.GREEN+'This parameter specifies the max days for the shredding script.'+Colors.RESET+'\n\nDefault:\n  - 90 Days\n\n'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
