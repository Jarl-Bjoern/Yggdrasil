...
"""
  ...
  if (osname == 'nt'):
      ...
      optional.add_argument('-sU','--start-urls', type=bool, nargs='?', const=True, help=Colors.GREEN+'This parameter skips the url opening part after the installation process.\n\n'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
