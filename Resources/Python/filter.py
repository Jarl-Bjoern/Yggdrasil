...
alias kali-repo-switch='if [[ $(cat /etc/apt/sources.list | head -n2 | grep -v "#" | cut -d ' ' -f3) == "kali-last-snapshot" ]]; then sed -i "s#deb https://http.kali.org/kali kali-last-snapshot main contrib non-free non-free-firmware#deb https://http.kali.org/kali kali-rolling main contrib non-free non-free-firmware#g" /etc/apt/sources.list ; echo "The repository was successfully changed to kali-rolling"; elif [[ $(cat /etc/apt/sources.list | head -n2 | grep -v "#" | cut -d ' ' -f3) == "kali-rolling" ]]; then sed -i "s#deb https://http.kali.org/kali kali-rolling main contrib non-free non-free-firmware#deb https://http.kali.org/kali kali-last-snapshot main contrib non-free non-free-firmware#g" /etc/apt/sources.list ; echo "The repository was successfully changed to kali-last-snapshot"; fi'
