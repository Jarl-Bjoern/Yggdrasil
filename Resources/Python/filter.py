...
"""+f"""alias git-tools-update='for i in $(cat {opt_path}/update.info); do echo -e "\033[1;33mUpdate:\033[0m" $i ; cd $i ; git pull ; echo -e "\033[0;36m------------------------------------------------\033[0m"; done'
alias cargo-tools-update='for i in $(cat {opt_path}/update.info); do echo -e "\033[1;33mUpdate:\033[0m" $i ; cd $i ; git pull ; echo -e "\033[0;36m------------------------------------------------\033[0m"; done'"""
