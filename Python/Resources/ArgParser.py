...
"""
  ...
  if (osname == 'nt'):
      ...
      optional.add_argument('-v','--verbose', type=bool, nargs='?', const=True, help=Colors.GREEN+'This parameter shows all messages during the apt package manager installation process.'+Colors.BLUE+'-------------------------------------------------------------------------------------'+Colors.RESET)
