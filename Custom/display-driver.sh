...
cat <<EOF | sudo bash displaylink-debian.sh || echo -e "\033[0;31mERROR: \033[0m\n\nUnfortunately, the script does not support the cat EOF automatism, please perform the installation manually." && sudo bash displaylink-debian.sh
i
Y
n
EOF
